...
<section class="section-Portfolio " id="PORTFOLIO">
    <h1 class="h1 text-center pt-4">Portfolio </h1> 
  <!-- <ul id="filters" class="clearfix d-flex justify-content-center">
    <li><span class="filter list-inline-item" data-filter=".app, .icon, .logo, .web"></span></li>
    <li><span class="filter list-inline-item" data-filter=".app"></span></li>
    <li><span class="filter list-inline-item" data-filter=".icon"></span></li>
    <li><span class="filter list-inline-item" data-filter=".logo"></span></li>
    <li><span class="filter list-inline-item" data-filter=".web"></span></li>
  </ul> -->
